; ModuleID = 'src/main2.c'
source_filename = "src/main2.c"
...
$"??_C@_0CC@BLHHIGKI@Hello?0?5World?$CB?6Int?$DN?$CFd?0?5Float?$DN?$CF?45f@" = comdat any

$"??_C@_0BD@CIEJADKN@Give?5me?5a?5number?3?5?$AA@" = comdat any

$"??_C@_02DPKJAMEF@?$CFd?$AA@" = comdat any

$"??_C@_0BB@OFOHKAIP@You?5gave?5me?3?5?$CFd?6?$AA@" = comdat any

@"??_C@_0CC@BLHHIGKI@Hello?0?5World?$CB?6Int?$DN?$CFd?0?5Float?$DN?$CF?45f@" = linkonce_odr dso_local unnamed_addr constant [34 x i8] c"Hello, World!\0AInt=%d, Float=%.5f\0A\00", comdat, align 1
@"??_C@_0BD@CIEJADKN@Give?5me?5a?5number?3?5?$AA@" = linkonce_odr dso_local unnamed_addr constant [19 x i8] c"Give me a number: \00", comdat, align 1
@"??_C@_02DPKJAMEF@?$CFd?$AA@" = linkonce_odr dso_local unnamed_addr constant [3 x i8] c"%d\00", comdat, align 1
@"??_C@_0BB@OFOHKAIP@You?5gave?5me?3?5?$CFd?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [17 x i8] c"You gave me: %d\0A\00", comdat, align 1
...
define dso_local i32 @main() #0 {
  ...
  %7 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0CC@BLHHIGKI@Hello?0?5World?$CB?6Int?$DN?$CFd?0?5Float?$DN?$CF?45f@", i32 noundef %6, double noundef %5)
  %8 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BD@CIEJADKN@Give?5me?5a?5number?3?5?$AA@")
  %9 = call i32 (ptr, ...) @scanf(ptr noundef @"??_C@_02DPKJAMEF@?$CFd?$AA@", ptr noundef %2)
  %10 = load i32, ptr %2, align 4
  %11 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BB@OFOHKAIP@You?5gave?5me?3?5?$CFd?6?$AA@", i32 noundef %10)
  ret i32 0
}
